...
public class AnalyzeProjectWorkflow(IConsoleWriter writer, PowerCommandsConfiguration configuration) : AnalyzeWorkflowBase(writer, configuration)
{
    public override void Run(params string[] args)
    {
        ...
        {
            writer.WriteSuccessLine($"No vulnerabilities found in {projectName}!");
            return;
        }
